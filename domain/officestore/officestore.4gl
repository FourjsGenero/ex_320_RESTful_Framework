...
public function getCategoryRecords(
    ...
    returns(dynamic array attribute(WSName = "categories") of
        categoryType attributes(XMLName = "category", WSMedia = "application/json, application/xml"))
...
public function getCategoryById(
    ...
    attributes(WSGet,
        ...
        #WSScope = "officestore.user",
        WSThrows = "404:Not Found,500:Internal Server Error")
    returns(categoryType attributes(XMLName = "category", WSMedia = "application/json, application/xml"))
...
#+
#+ Creates categories from data source
#+
#+ @code CALL insertCategory(newRecord)
#+
#+ @param newRecord : categoryType : A record of values used to create a new resource
#+
#+ @returnType NONE
#+
public function insertCategory(
    recordId string attributes(WSParam), newRecord categoryType attributes(WSMedia = "application/json, application/xml"))
    attributes(WSPost,
        WSPath = "/v1/categories/{recordId}",
        WSDescription = "Adds a new element to the categories resource.",
    ...
    try
        prepare categoriesIns from CAT_INSERTSQL
        execute categoriesIns using newRecord.*
        free categoriesIns
    catch
        call logger.logEvent(
            logger.C_LOGSQLERROR,
            ...
            sfmt("SQL statement: %1", CAT_INSERTSQL))
        call com.WebServiceEngine.SetRestError(C_HTTP_NOTFOUND, null)
    end try
...
#+
#+ Updates categories for specific ID in data source
#+
#+ @code
#+ CALL updateCategoryById(id, updateRecord)
#+
#+ @param resourceId : STRING : id of the categories being updated
#+ @param updateRecord : categoryType : A record of values used to update a resource
#+
#+ @returnType NONE
#+
public function updateCategoryById(
    resourceId string attributes(WSParam), updateRecord categoryType attributes(WSMedia = "application/json, application/xml"))
    attributes(WSPut,
        WSPath = "/v1/categories/{resourceId}",
        WSDescription = "Updates an element of the categories resource.",
        #WSScope = "officestore.supervisor",
        WSRetCode = "204:No Content",
        WSThrows = "404:Not Found,500:Internal Server Error")

    try
        prepare categoriesUpdt from CAT_UPDATESQL
        execute categoriesUpdt using updateRecord.catname, updateRecord.catdesc, updateRecord.catpic, updateRecord.catid
        free categoriesUpdt
        ...
        call logger.logEvent(
            ...
            sfmt("%1:%2", __FILE__, __LINE__),
            sfmt("SQL code: %1", SQLCA.sqlcode),
            sfmt("SQL statement: %1", CAT_UPDATESQL))
        call com.WebServiceEngine.SetRestError(C_HTTP_INTERNALERROR, null)
    end try
...
#+
#+ @code CALL deleteCategoryById(thisid)
#+
...
public function deleteCategoryById(
    ...
    attributes(WSDelete,
        WSPath = "/v1/categories/{resourceId}",
        WSDescription = "Deletes an element from the categories resource.",
        #WSScope = "officestore.admin",
        WSThrows = "404:Not Found,500:Internal Server Error")

    try
        prepare categoryDel from CAT_DELETESQL
        execute categoryDel using resourceId
        free categoryDel
    catch
        call logger.logEvent(
            logger.C_LOGSQLERROR,
            sfmt("categories:%1", __LINE__),
            sfmt("SQL code: %1", SQLCA.sqlcode),
            sfmt("SQL statement: %1", CAT_DELETESQL))
        call com.WebServiceEngine.SetRestError(C_HTTP_INTERNALERROR, null)
    end try
...
public function getCountryRecords(
    ...
    returns(dynamic array attribute(WSName = "countries") of
        countryType attributes(XMLName = "country", WSMedia = "application/json, application/xml"))
...
public function getCountryRecordsV2(
    ...
    attributes(WSGet,
        ...
        #WSScope = "officestore.user",
        WSThrows = "404:Not Found,500:Internal Server Error")
    #returns(dynamic array attribute(WSName = "countries") of countryType attributes(XMLName = "country", WSMedia = "application/json, application/xml"))
    returns string
...
public function getCountryById(
    ...
    returns(countryType attributes(XMLName = "country", WSMedia = "application/json, application/xml"))
...
public function getSupplierRecords(
    ...
    attributes(WSGet,
        ...
        #WSScope = "officestore.user",
        WSThrows = "404:Not Found,500:Internal Server Error")
    returns(dynamic array of supplierType attributes(WSMedia = "application/json, application/xml"))
    #returns(string attributes(WSMedia = "application/json, application/xml"))
...
public function getSupplierById(
    ...
    attributes(WSGet,
        ...
        #WSScope = "officestore.user",
        WSThrows = "404:Not Found,500:Internal Server Error")
    returns(supplierType attributes(WSMedia = "application/json, application/xml"))
...
#+ @returnType NONE
#+ @return NONE
private function initSuppliers()
